...
const NotificationsPage = () => {
    ...
    const renderActionText = (text, actionBy) => {
        ...
        const parts = mainText.split(/(مدير شؤون الطلاب|مدير عام|مسؤول كلية|مدير برنامج|حذف|مسح|تعديل|حفظ|إضافة مستخدم جديد|اضافة مستخدم جديد|إضافة|إضافه|الجدول الرئيسي الموحد|الجدول الرئيسي|نموذج 1|نموذج 2|طباعة|تنزيل|رؤية|استرجاع|تفعيل صلاحية|الغاء صلاحية|إلغاء صلاحية|الغاء المراجعة الاولى|إلغاء المراجعة الاولى|الغاء المراجعة الأولى|إلغاء المراجعة الأولى|الغاء المراجعة الثانية|إلغاء المراجعة الثانية|الغاء إنهاء الخطة|إلغاء إنهاء الخطة|الغاء اعتماد|إلغاء اعتماد|الغاء|إلغاء|المراجعة الأولى|المراجعة الثانية|إنهاء الخطة|إنهاء|اعتماد الخطة الدراسية|اعتماد)/g);
        ...
        return parts.map((part, index) => {
            ...
            if (part === 'الجدول الرئيسي الموحد' || part === 'الجدول الرئيسي') {

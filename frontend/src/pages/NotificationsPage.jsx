...
const NotificationsPage = () => {
    ...
    const renderActionText = (text, actionBy) => {
        ...
        return parts.map((part, index) => {
            ...
            const redKeywords = ['حذف', 'مسح', 'الغاء', 'إلغاء', 'الغاء اعتماد', 'إلغاء اعتماد', 'الغاء المراجعة الاولى', 'إلغاء المراجعة الاولى', 'الغاء المراجعة الأولى', 'إلغاء المراجعة الأولى', 'الغاء المراجعة الثانية', 'إلغاء المراجعة الثانية', 'الغاء إنهاء الخطة', 'إلغاء إنهاء الخطة', 'الغاء صلاحية', 'إلغاء صلاحية', 'استقطاع', 'انتقاص', 'خصم'];

...
const GuidelinesPage = () => {
  ...
  const systemPages = [
    ...
    },
    {
      ...
      badgeColor: "purple",
      whatIsIt: "لوحة متكاملة لإدارة ومراقبة الأنصبة والأعباء التدريسية وتخصيص عدد أسابيع المقررات الدراسية، واستعراض المقررات المسندة لكل أستاذ، وتسجيل استقطاعات وتخفيض الساعات بدقة مع ربطها بالمقرر ونوع الساعات والأسابيع والسبب.",
      benefit: "ت المرونة الكاملة في معالجة المقررات التي لا تستمر لكامل الفصل الدراسي، وتوثيق أي استقطاع أو غياب أو إجازة مع احتساب فوري لصافي الساعات في الترم، وطباعة وتصدير الكشوف الرسمية المعتمدة للإدارة والشؤون المالية.",
      keyFeatures: [
        ...
        "جدول شامل لجميع أعضاء هيئة التدريس المستقطع منهم بالكلية مع إمكانية التعديل عليه وطباعته أو تنزيله"
      ]
    },
    {
      id: "signatures",
                ...
                <Row className="g-4 mb-4">
                  ...
                  <Col md={3}>
                    <div className="p-4 bg-white rounded-3 border text-center h-100 shadow-sm position-relative" style={{ border: "2px solid #2e7d32 !important" }}>
                      ...
                      <p className="small text-muted mb-0" style={{ lineHeight: "1.6" }}>
                        يقوم صاحب الصلاحية <strong>مدير إدارة إدارة شؤون التعليم والطلاب</strong> بالضغط على <strong>إعتماد الخطة</strong> فيمنع أي تعديل في الخطة حتى التوقيعات وتصبح خطة رسمية.
                      </p>
                    </div>
                  </Col>
                </Row>

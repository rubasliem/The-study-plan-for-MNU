  ...
  const systemPages = [
    {
      ...
      keyFeatures: [
        ...
        "إجمالي الساعات الفعلية لكل أستاذ في الترم ولكل عام دراسي",
      ]
    },
    {
      id: "professors",
    ...
    },
    {
      ...
      keyFeatures: [
        ...
        "ميزة استيراد من Excel ونسخ الخطة بالكامل من فصل أو عام سابق لتوفير الجهد والوقت"
      ]
    },
    {
      id: "workload",
      title: "تحديد الأعباء التدريسية",
      icon: <FaBalanceScale className="text-purple fs-3" />,
      badge: "الأنصبة والاستقطاعات",
      badgeColor: "purple",
      whatIsIt: "لوحة متكاملة لإدارة ومراقبة الأنصبة والأعباء التدريسية، تشمل تحديد حدود ساعات العمل اليومية (نظري، عملي، وتوتوريال وحقل)، وتخصيص عدد أسابيع المقررات الدراسية، واستعراض المقررات المسندة لكل أستاذ، وتسجيل استقطاعات وتخفيض الساعات بدقة مع ربطها بالمقرر ونوع الساعات والأسابيع والسبب.",
      benefit: "تتيح للإدارة الأكاديمية والكلية ضبط توازن الأعباء التدريسية وضمان عدم تجاوز الحدود اليومية القانونية، مع المرونة الكاملة في معالجة المقررات التي لا تستمر لكامل الفصل الدراسي، وتوثيق أي استقطاع أو غياب أو إجازة مع احتساب فوري لصافي الساعات في الترم، وطباعة وتصدير الكشوف الرسمية المعتمدة للإدارة والشؤون المالية.",
      keyFeatures: [
        "تحديد وتثبيت الحدود اليومية لساعات التدريس (الحدين الأدنى والأقصى) لمختلف أنواع الساعات",
        "تخصيص عدد أسابيع المقررات الدراسية التي تنتهي في مدة أقل من الفصل الدراسي، وافتراض تلقائي لباقي المقررات",
        "استعراض تفصيلي لأعباء كل عضو هيئة تدريس والمقررات المكلف بها بالخطة الدراسية",
        "بطاقة معاينة فورية لحساب إجمالي ساعات الترم وإجمالي الخصومات وصافي الساعات التدريسية للأستاذ قبل الحفظ",
        "جدول شامل لجميع أعضاء هيئة التدريس المستقطع منهم بالكلية مع إمكانية إلغاء التخفيض عند الحاجة",
        "طباعة بيان رسمي معتمد لجدول الاستقطاعات بتنسيق الجداول المعتمد، أو تصديره مباشرة إلى شيت Excel منسق"
      ]
    },
    {
      id: "signatures",
